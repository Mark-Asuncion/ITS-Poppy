...
export class Tutorial06 extends Tutorial {
    ...
    switch(this.cursor) {
        ...
        case 4:
            Poppy.display({
                message: "Here’s how you can use try and except to handle that error:<span class=\"info\"><br>num1 = 10<br>num2 = 0<br>try:<br>\tresult = num1 / num2<br>\tprint(result)<br>except ZeroDivisionError:<br>\tprint('Cannot divide by zero!')</span>",
